#!/usr/bin/env python3
"""Run one regularizer family from the frozen HRMC production bracket."""
...
parser.add_argument("--model", choices=("pedone", "gap"), required=True)
...
root = case_root / "results/hrmc-production-bracket"
