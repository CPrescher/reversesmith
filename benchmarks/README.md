...
| `epsr-silica` | Published EPSR silica-glass example | Demonstrate a chemically plausible network-glass model | First reproduce native EPSR totals and structural distributions, then compare MLIP-HRMC at matched fit quality | Forward and reference-potential gates passed; joint epoch smoked; stochastic reproduction pending; publication permission required |
