...
| `epsr-ga` | Published EPSR liquid-Ga example | Demonstrate empirical-potential refinement for a simple liquid | Match the fitted total scattering and ensemble RDF within stochastic uncertainty | Inputs to acquire |
| `epsr-silica` | Published EPSR silica-glass example | Demonstrate a chemically plausible network-glass model | Match total scattering, partial RDFs, coordination, and angular distributions | Official files identified; publication permission required |
