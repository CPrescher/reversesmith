...
| `hp-sio2` | Sequential 0-to-10 GPa Erhard-2024 ACE compression | Recover non-affine high-pressure changes from the affinely compressed 0 GPa glass | Compare pure RMC, ACE-HRMC, and stock EPSR26 against hidden 10 GPa structure at fixed density | Five-seed pilot: PACE beats EPSR hidden-RDF recovery in 5/5 pairs, but the overall gate fails because PACE has local minimum-distance violations in 5/5 endpoints |
