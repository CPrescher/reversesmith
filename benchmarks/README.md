...
| `hp-sio2` | Sequential Erhard-2024 ACE compression | Recover non-affine pressure changes from the preceding-pressure glass | Compare pure RMC, ACE-HRMC, and stock EPSR26 against hidden pressure endpoints at fixed density | PACE beats EPSR hidden-RDF recovery in 5/5 direct-jump seeds and both incremental steps; sequential 0->5->10 removes the severe direct-jump contacts, but the pressure-relative O-O lower-tail guard remains unresolved |
